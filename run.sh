...
for i in `seq 1 5`;
do
    ./ICE/ICE/ice -text data/omdb_ice_tt.txt -entity data/omdb_ice_et.txt -textrep data/text.embd -save data/result${i}.txt -textcontext data/context.txt -dim 300 -sample 200 -neg 2 -alpha 0.025 -thread 20 
done
...
do
    ...
    do
        ...
        do
            ./ICE/ICE/ice -text data/omdb_ice_tt.txt -entity data/omdb_ice_et.txt -save sensi_test/dim${dim}_samp${samp}_result${i}.txt -dim ${dim} -sample ${samp} -neg 2 -alpha 0.025 -thread 20 
        done
    done
done
